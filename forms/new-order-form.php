...
<form id="newOrder" class="ui form" action ="index.php" method= "POST">
  ...
  <div class="field">
    ...
    <div class="sixteen wide field">
      <div class="field">
        <input type="text" name="email" placeholder="Order Name">
      </div>
    </div>
  </div>
  <div class="field">
    ...
    <div class="two fields"> 
      <div class="eight wide field">
        <input type="text" name="reciepent" placeholder="Reciepent">
      </div>
      <div class="eight wide field">
...
<?php     
  ...
  if(array_key_exists('proceed-order', $_POST)) { 
      ...
      curl_setopt_array($curl, array(
        ...
        "shipByDate": "'.date("Y-m-d").'",
        "orderStatus": "awaiting_shipment",
        "customerId": 37701499,
        "customerUsername": "'.$_SESSION['email'].'",
